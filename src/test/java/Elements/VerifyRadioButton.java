...
public class VerifyRadioButton {
	...
	public void clickButton() {
		...
		WebElement Button = driver.findElement(By.xpath(prop.getProperty("radioButton")));
		js.executeScript("arguments[0].click();", Button );
		WebElement Radio =  driver.findElement(By.xpath(prop.getProperty("clickRadioButton")));
