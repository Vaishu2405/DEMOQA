...
public class SelectMltipleCheckbox {
	...
	public void elements() {
		...
		WebElement Expand = driver.findElement(By.xpath(prop.getProperty("expandAll")));
		 //js.executeScript("arguments[0].click();", Expand );
		 WebElement mltipleCheckbox = driver.findElement(By.xpath(prop.getProperty("expandAll")));
		// js.executeScript("arguments[1].click();", mltipleCheckbox );
	}
